#!/bin/bash
#Script Name: w10-Postfix-presetup.sh
#Script Purpose: to Install, Configure, and validate DNS, and firewall settings for Postfix
...
#disallowing traffic on ALIAS network
